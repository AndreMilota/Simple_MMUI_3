...
class Window(Back_End):
    def __init__(self, title="GUI 4", transcriber=None, number_of_buttons=3):
        ...
        for i in range(number_of_buttons):
            button = tk.Button(self.root, text=f"Button {i}", command=lambda i=i: self.button_clicked(i))
    ...
    def set_button_color(self, button_index, color):
        ...
        self.delayed_action.append(lambda : self.buttions[button_index].config(background=color))
        # if button_index == 1:
